                            ...
                            >
                                <div className='row mt-2'>
                                    <div className='col-md-6'>
                                        <p className="mt-3"> <strong>25 mm LMS (Low Mechanical Strength) GI Conduit</strong> <br /> <strong>Package</strong>: Electric Pole </p>
                                    ...
                                    <div className='col-md-6'>
                                        ...
                                        <input style={{ visibility: 'hidden' }} type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value = "Kamal Nath Road, Kurla East, Mumbai - 400024" required />
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <p className="ml-5"><strong>Freight Rate (Mumbai): </strong> Rs 3000</p>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mt-4">
                                        ...
                                        <p className="ml-5 mt-5"><strong>Insurance </strong> Rs 10000</p>
