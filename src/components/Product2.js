                                ...
                                >
                                    <div className='row mt-2'>
                                        <div className='col-md-6'>
                                            <p className="mt-3"> <strong>32 mm LMS (Low Mechanical Strength) GI Conduit</strong> <br /> <strong>Package</strong>: Electric Pole </p>

                                            <p style={{ color: 'grey' }}>DELIVERY DETAILS</p>
                                            <label for="exampleInputEmail1">Company Name</label>
                                            <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name='company' value={company} onChange = {handleChange} required />

                                            {/* <p className=" mt-4" style={{ color: 'grey' }}>LOCATION1</p> */}
                                            <label for="exampleInputEmail1">Address</label>
                                            <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name='address' onChange = {handleChange}  value={address} required />
                                        ...
                                        <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" /> */}
                                            ...
                                            <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name='contact' value={contact} onChange = {handleChange}  required />
                                        </div>
                                    </div>
